...
function updateGraphTitle() {
	d3.select("#sdv-graph-title").text(graphDescription);
}
...
function renderGraph() {
		...
		.append("rect")
			...
			.attr("width", function(d) {
 			...
 			.attr("fill", function (d) {
 				if (d.drawProfit >= 0)
					return options.barColors.profit.positive;
				else
					return options.barColors.profit.negative;
 			});
	...
	barsSeed = gSeedLoss.selectAll("rect")
		...
		.append("rect")
			...
			.attr("width", barWidth / miniBar)
 			.attr("fill", options.barColors.seedLoss);
	...
	barsFert = gFertLoss.selectAll("rect")
		...
		.append("rect")
			...
			.attr("width", barWidth / miniBar)
 			.attr("fill", options.barColors.fertLoss);
...
function deserialize(str) {
    try {
        ...
        console.warn("Invalid URL hash. Resetting.");
